...
# ============================================================
# FIGURA 1 — Grafico velocità media
# ============================================================
fig1, ax_graf = plt.subplots(figsize=(11, 6))
...
# FIGURA 2 — Tabella
# ============================================================
fig2, ax_tab = plt.subplots(figsize=(8, 8))
ax_tab.axis("off")

col_labels = ["Anno", "Top speed, (km/h)", "Vel. media, (km/h)", "Tempo sul giro"]
table_data = []
